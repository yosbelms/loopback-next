...
export {tryReadDir};
export {resolveRelativePaths};
export {assertIsValidConfig};
export {fileExistsSync};
export {fixFileExtension};
export {findScripts};
export {resolveAppScriptPath};
export {getExcludedExtensions};
export {tryResolveAppPath};
export {forEachKeyedObject};
export {mergePhaseNameLists};

export const FILE_EXTENSION_JSON = exports.FILE_EXTENSION_JSON = '.json';
/**
