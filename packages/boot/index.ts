...
// Strong globalize
import g from './src/globalize';

import {PluginBase} from './src/plugin-base';
import {Bootstrapper} from './src/bootstrapper';
import addInstructionsToBrowserify from './src/bundler';
...
export function compile(options, done) {
  const bootstrapper = new Bootstrapper(options);
...
export {addInstructionsToBrowserify};
export {Bootstrapper};
export {PluginBase};

export function execute(app, instructions, done) {
